...
public final class Integrals {
	 ...
	 */
	public static double overlap(final double alpha1, final Power power1, final Vector3D a, final double alpha2,
	 ...
	 */
	public static double kinetic(final double alpha1, final Power power1, final Vector3D a, final double alpha2,
			final Power power2, final Vector3D b) {
	 ...
	 */
	public static double nuclearAttraction(final Vector3D a, final double norm1, final Power power1,
			final double alpha1, final Vector3D b, final double norm2, final Power power2, final double alpha2,
			final Vector3D c) {
	 ...
	 */
	public static Vector3D nuclearAttractionGradient(final Vector3D a, final Power power1, final double alpha1,
	 ...
	 */
	public static double coulomb(final ContractedGaussian a, final ContractedGaussian b, final ContractedGaussian c,
	 ...
	 * @return Two-electron integral.
	 */
	public static double coulomb(final PrimitiveGaussian a, final PrimitiveGaussian b, final PrimitiveGaussian c,
			final PrimitiveGaussian d) {
